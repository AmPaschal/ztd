...
public class AddRuntimePermissionAdapter extends LocalVariablesSorter {

    public AddRuntimePermissionAdapter(int access, String descriptor, MethodVisitor methodVisitor) {
        super(Opcodes.ASM9, access, descriptor, methodVisitor);
//        System.out.println("Runtime Premission Adapter called");
    }
...
//            User supplied. Loads variable to top of stack
            ...
            methodVisitor.visitLdcInsn("Runtime Execution Permission not granted");
